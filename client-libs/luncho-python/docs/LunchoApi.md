...
[**country_ppps**](LunchoApi.md#country_ppps) | **GET** /country-PPPs | Countryppps
...
# **country_ppps**
> {str: (IMFPPPCountry,)} country_ppps()
...
with luncho-python.ApiClient() as api_client:
    ...
    try:
        # Countryppps
        api_response = api_instance.country_ppps()
        pprint(api_response)
    except luncho-python.ApiException as e:
        print("Exception when calling LunchoApi->country_ppps: %s\n" % e)
```
